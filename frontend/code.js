...
displayMessage("Chatbot", "Hello, I am the Book Bot. I can provide you with information about an author's books, including their price, description, and even share the direct link for you to purchase them.");
...
async function sendMessage(message) {
    ...
    try {
      const response = await fetch(
        "http://localhost:8098/webhooks/rest/webhook",
        {
          method: "POST",
          headers: {
